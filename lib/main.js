var _ = require("underscore"),
	...
	Strategy = require("passport-amigame").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/amigame/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('amigame', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('amigame', arguments[0]);
		}
	},
